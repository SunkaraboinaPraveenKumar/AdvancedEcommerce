...
const CategoryShowCase = () => {
  ...
  return (
    <div className='course-section style-3 padding-tb'>
        <div className='course-shape one'><img src="/images/shape-img/icon/01.png" alt="" /></div>
        <div className='course-shape two'><img src="/images/shape-img/icon/02.png" alt="" /></div>
        {/* main section */}
